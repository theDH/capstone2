...
//	public static final String MAIN_MENU_OPTION_CAMPGROUND_LIST = "Display Campgrounds at Park";
	...
	public static final String[] MAIN_MENU_OPTIONS = new String[] {MAIN_MENU_OPTION_PARKS,
																	MAIN_MENU_OPTION_EXIT };
	

	public static final String CAMPGROUND_MENU_OPTION_VIEW_CAMPGROUND = "View Campgrounds";
	public static final String CAMPGROUND_MENU_OPTION_SEARCH_FOR_RESERVATION = "Search for Reservations";
	public static final String CAMPGROUND_MENU_OPTION_RETURN_TO_PREVIOUS = "Return to Previous Screen";
	public static final String [] CAMPGROUND_MENU_OPTIONS = new String[] { 
															CAMPGROUND_MENU_OPTION_VIEW_CAMPGROUND, 
